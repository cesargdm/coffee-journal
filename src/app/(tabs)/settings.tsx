    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <SettingSection title="Data">
          <SettingItem title="Export Data" subtitle="Export your coffee logs as CSV" />
          <View style={styles.divider} />
          <SettingItem title="Import Data" subtitle="Import coffee logs from CSV" />
        </SettingSection>

        <SettingSection title="About">
          <SettingItem title="Version" subtitle="1.0.0" />
          <View style={styles.divider} />
          <SettingItem title="Privacy Policy" subtitle="View our privacy policy" />
          <View style={styles.divider} />
          <SettingItem title="Terms of Service" subtitle="View our terms of service" />
        </SettingSection>
      </ScrollView>
    </SafeAreaView>
  );
