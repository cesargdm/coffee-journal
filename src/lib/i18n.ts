...
const messagesCatalog = {
	en: {
		...
		'Create your first coffee log to start your journey':
			'Create your first coffee log to start your journey',
		'Dark Mode': 'Dark Mode',
		Home: 'Home',
		Language: 'Language',
	...
	es: {
		...
		'Create your first coffee log to start your journey':
			'Crea tu primer registro de café para comenzar tu viaje',
	...
	pt: {
		...
		'Create your first coffee log to start your journey':
			'Crie seu primeiro registro de café para começar sua jornada',
		...
		'Start your coffee journey by recording your first tasting experience':
			'Comece sua jornada do café',
		Tactile: 'tátil',
		Tongue: 'língua',
		'Use dark theme throughout the app':
			'Usar tema escuro em todo o aplicativo',
		Version: 'Versão',
	},
}
...
export function dynamicActivate(locale: string) {
	try {
		...
		const messages =
			messagesCatalog[locale as keyof typeof messagesCatalog] || // eslint-disable-line @typescript-eslint/no-unnecessary-condition
